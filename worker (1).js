...
export default {
  async fetch(request, env) {
    ...
    */
    ...
    const systemPrompt =
      "You are a Japanese language tutor for beginner-level Japanese learners. " +
      "Be patient, supportive and correct mistakes gently. " +
    ...
    const userPrompt =
      ...
      `Learner response:\n${responseText}\n\n` +
      "The learning objective is to be able to explain what you did this past weekend in Japanese in a few sentences using time expressions (i.e., days), location words and actions.\n" +
